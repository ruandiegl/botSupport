...
router.post("/zapi/groups/:groupId/read", authMiddleware, requirePermission("groups", "view"), (req, res) => zApiController.markGroupRead(req, res));
router.post("/zapi/groups/:groupId/media", authMiddleware, requirePermission("groups", "send_message"), (req, res) => zApiController.sendGroupMedia(req, res));
